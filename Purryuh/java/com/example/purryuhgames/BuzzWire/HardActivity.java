package com.example.purryuhgames.BuzzWire;
...
public class HardActivity extends AppCompatActivity implements View.OnTouchListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.buzzwire_activity_hard);
        ...
        // Hit and finish box
        hitBoxImageView = new ImageView[116];
        for (int i = 0; i < 116; i++) {
        ...
        switch (event.getAction() & MotionEvent.ACTION_MASK) {
            ...
            case MotionEvent.ACTION_MOVE:
                ...
                if (isIntersecting(loopImageView, finishBoxImageView)) {
                    ...
                    user.setScoreHard(timerManager.getTime());
                    indicator.setFlag("Hard");

                    compareScore(user.getScoreHard(), user.getBestScoreHard());
    ...
    public void compareScore(String currentScore, String bestScore) {
        ...
        if (bestScore.equals("00:00")) {
            user.setBestScoreHard(currentScore);
